...
export default function Stats() {
  return (
    <div className="mx-auto max-w-8xl px-4 py-2 md:px-8 lg:px-8">
      ...
      <dl className="dark:bg-zinc-800 mt-5 grid grid-cols-1 divide-y divide-zinc-200 overflow-hidden rounded-lg bg-white shadow md:grid-cols-3 md:divide-x md:divide-y-0">
        {stats.map((item) => (
