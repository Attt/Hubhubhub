    ...
    return (
        <ul role="list" className="dark:divide-zinc-800 divide-y divide-zinc-100">
            {taskConfigs && taskConfigs.length > 0 && taskConfigs.map((taskConfig) => (
                ...
                className={
                    configIdList.includes(taskConfig.id) ? 'dark:hover:bg-green-600/10 text-green-600 bg-green-600 ring-green-500/10 rounded-md relative flex justify-between gap-x-6 px-4 py-5 hover:bg-zinc-600 sm:px-6 lg:px-8' : 'dark:hover:bg-zinc-400 rounded-md relative flex justify-between gap-x-6 px-4 py-5 hover:bg-zinc-600 sm:px-6 lg:px-8'
                }
                >
